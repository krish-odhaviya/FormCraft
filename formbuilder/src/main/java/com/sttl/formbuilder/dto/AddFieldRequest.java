...
public class AddFieldRequest {
    ...
    @Pattern(
            regexp = "^(TEXT|TEXTAREA|EMAIL|INTEGER|DATE|TIME|DATETIME|PHONE|BOOLEAN|RADIO|CHECKBOX_GROUP|DROPDOWN|STAR_RATING|LINEAR_SCALE|FILE_UPLOAD|MC_GRID|TICK_BOX_GRID|LOOKUP_DROPDOWN|SECTION|LABEL|PAGE_BREAK|GROUP)$",
